...
public class PlaceAdaptor extends ArrayAdapter<String> implements Filterable {
	...
	private static final String API_KEY = Appconstants.API_KEY_FOR_PLACE_SEARCH;

	public PlaceAdaptor(Context context, int resource) {
